...
namespace Kentico.Kontent.ModelGenerator.Core
{
    public class ClassCodeGenerator
    {
        ...
        public const string DEFAULT_FILE_COMMENT_PREFIX =
@"//--------------------------------------------------------------------------------------------------
// <auto-generated>
...
//--------------------------------------------------------------------------------------------------";
        ...
        public const string PARTIAL_FILE_COMMENT_PREFIX =
        @"//--------------------------------------------------------------------------------------------------
// <auto-generated>
// This code was generated by a kontent-generators-net tool 
// (see https://github.com/Kentico/kontent-generators-net).
...
//--------------------------------------------------------------------------------------------------";
        ...
        public string GenerateCode(bool cmApi = false)
        {
            ...
            var description = SyntaxFactory.Comment(DEFAULT_FILE_COMMENT_PREFIX + Environment.NewLine + Environment.NewLine);
            if (CustomPartial)
            {
                description = SyntaxFactory.Comment(PARTIAL_FILE_COMMENT_PREFIX + Environment.NewLine + Environment.NewLine);
            }
