...
{
    public abstract class ClassCodeGeneratorBase
    {
        ...
        protected ClassCodeGeneratorBase(ClassDefinition classDefinition, string classFilename, string @namespace = DEFAULT_NAMESPACE, bool customPartial = false)
        {
