...
// It will maintain an up-to-date list of the Content types avaiable 
// </auto-generated>
//--------------------------------------------------------------------------------------------------";
...
{CreateCodenameDictionaryValues()}
        ...
        {{
            ...
            var description = SyntaxFactory.Comment(TypeProviderCodeGenerator.FILE_COMMENT_PREFIX + Environment.NewLine + Environment.NewLine);
