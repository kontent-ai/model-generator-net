...
{
    private readonly IManagementElementService _managementElementService;

    public ManagementElementServiceTests()
    {
        _managementElementService = new ManagementElementService();
    }
    ...
    public void GetManagementContentTypeSnippetElements_ManagementSnippetsAreNull_ThrowsException()
    {
        var getManagementContentTypeSnippetElementsCall = () =>
            _managementElementService.GetManagementContentTypeSnippetElements(new TextElementMetadataModel(), null);
    ...
    {
        var getManagementContentTypeSnippetElementsCall = () =>
            _managementElementService.GetManagementContentTypeSnippetElements(null, new List<ContentTypeSnippetModel>());
    ...
    public void GetManagementContentTypeSnippetElements_NoSnippetElements_Throws()
    {
        ...
        var result = _managementElementService.GetManagementContentTypeSnippetElements(snippetElement, snippets);
    ...
    public void GetManagementContentTypeSnippetElements_NoSnippets_Throws()
    {
        ...
        var getManagementContentTypeSnippetElementsCall =
            () => _managementElementService.GetManagementContentTypeSnippetElements(snippetElement, new List<ContentTypeSnippetModel>());
    ...
    public void GetManagementContentTypeSnippetElements_NoMatchingSnippet_Throws()
    {
        ...
        var getManagementContentTypeSnippetElementsCall = () => _managementElementService.GetManagementContentTypeSnippetElements(snippetElement, snippets);
    ...
    public void GetManagementContentTypeSnippetElements_NotManagementContentTypeSnippetElement_ReturnsNull()
    {
        ...
        var result = _managementElementService.GetManagementContentTypeSnippetElements(element, new List<ContentTypeSnippetModel>());
    ...
    public void GetManagementContentTypeSnippetElements_Returns()
    {
        ...
        var result = _managementElementService.GetManagementContentTypeSnippetElements(snippetElement, snippets).ToList();
